...
class YoutubeDL(object):
    ...
    def extract_info(self, url, download=True, ie_key=None, extra_info={},
        ...
        for ie in ies:
            ...
            # <youtube_dl.extractor.youtubeX.YoutubeIE object at 0x7fa6fdac0e10>
            # 打印流程，大法好
            print(ie)
            print("deng_ 1 ")
            if not ie.working():
    ...
    def process_ie_result(self, ie_result, download=True, extra_info={}):
        ...
        if result_type == 'video':
            ...
            raise Exception('这里出错了： Invalid result type: %s' % result_type)



# youtube - dl 是把 audio 和 vedio 一起处理的，
